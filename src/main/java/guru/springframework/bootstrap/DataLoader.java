...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeasureRepository.findUnitOfMeasureByDescription("Cup");
        ...
        //get Categories
        Optional<Category> americanCategoryOptional = categoryRepository.findCategoriesByDescription("American");

        if(!americanCategoryOptional.isPresent()){
            throw new RuntimeException("Expected Category Not Found");
        }

        Optional<Category> mexicanCategoryOptional = categoryRepository.findCategoriesByDescription("Mexican");
        ...
        tacoNotes.setRecipe(guacRecipe);
